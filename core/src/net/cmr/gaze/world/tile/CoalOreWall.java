...
public class CoalOreWall extends Tile implements WallTile {

	public CoalOreWall() {
		super(TileType.COAL_ORE_WALL);
	}

	@Override
	public void render(Gaze game, GameScreen screen, int x, int y) {
		draw(game.batch, game.getSprite("coalOreWall"+TileUtils.getBreakSpriteInt(this, 3)), x, y-1, 1, 3);
	...
	public Tile readTile(DataInputStream input, TileType type) throws IOException {
		CoalOreWall wall = new CoalOreWall();
