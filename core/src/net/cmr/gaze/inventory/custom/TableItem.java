...
public class TableItem extends Placeable {

	public TableItem(int amount) {
		super(ItemType.TABLE, amount);
	}
	public TableItem() {
		super(ItemType.TABLE, 1);
	}
	...
	protected void draw(Gaze game, Batch batch, float x, float y, float width, float height) {
		batch.draw(game.getSprite("table"), x, y, width, height);
	}
